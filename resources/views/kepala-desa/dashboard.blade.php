...
@section('title', 'Dashboard Kepala Desa - Hujjatul')
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <!-- Recent Pengajuan -->
        <div class="bg-white rounded-lg shadow-md p-6">
            <h3 class="text-lg font-semibold text-gray-800 mb-4">Pengajuan Terbaru</h3>
            <div class="space-y-3">
                ...
                <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                    ...
                    <div class="ml-3 flex-1">
                        <p class="text-sm font-medium text-gray-900">{{ $pengajuan->penduduk ? $pengajuan->penduduk->nama_lengkap : '-' }}</p>
