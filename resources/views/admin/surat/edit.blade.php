...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center space-x-4">
        ...
        <div>
            ...
            <p class="text-gray-600 mt-1">Edit arsip surat</p>
        </div>
    </div>

    <!-- Form -->
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('admin.surats.update', $surat) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="mb-4 p-4 bg-gray-50 rounded-lg">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-900">{{ $surat->file_name }}</p>
                ...
                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-indigo-500 transition-colors">
                    <div class="space-y-1 text-center">
                        ...
                        <p class="text-xs text-gray-500">
                            PDF, DOC, DOCX hingga 10MB. Kosongkan jika tidak ingin mengubah file.
                        </p>
                    </div>
                </div>
                @error('file')
