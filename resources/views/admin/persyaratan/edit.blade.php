...
<div class="mb-6">
    <div>
        ...
        <h1 class="text-2xl font-bold text-gray-800">Edit Persyaratan</h1>
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <form action="{{ route('admin.persyaratans.update', [$layanan->id, $persyaratan->id]) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="nama_dokumen" name="nama_dokumen"
                        ...
                        value="{{ old('nama_dokumen', $persyaratan->nama_dokumen) }}"
                ...
                <div>
                    ...
                    <textarea id="keterangan" name="keterangan" rows="3"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                        placeholder="Tambahkan keterangan atau deskripsi untuk dokumen ini">{{ old('keterangan', $persyaratan->keterangan) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="tipe_file" name="tipe_file"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                        value="{{ old('tipe_file', $persyaratan->tipe_file) }}"
                ...
                <div>
                    ...
                    <input type="number" id="max_size" name="max_size" min="1"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                        value="{{ old('max_size', $persyaratan->max_size) }}"
            ...
            <div class="mt-6 p-4 bg-gray-50 rounded-lg">
                <div class="grid grid-cols-2 gap-4 text-sm">
                    <div>
                        ...
                        <p class="text-gray-900">{{ $persyaratan->created_at->format('d/m/Y H:i') }}</p>
                    </div>
                    <div>
                        <span class="text-gray-500">Terakhir diupdate:</span>
                        <p class="text-gray-900">{{ $persyaratan->updated_at->format('d/m/Y H:i') }}</p>
                    </div>
                </div>
            </div>
