...
@section('title', 'Edit Layanan - Hujjatul')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="4"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                        placeholder="Deskripsikan layanan ini secara singkat">{{ old('deskripsi', $layanan->deskripsi) }}</textarea>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-blue-700">
                                Layanan ini dibuat pada <strong>{{ $layanan->created_at->format('d F Y, H:i') }}</strong> 
                                dan terakhir diperbarui pada <strong>{{ $layanan->updated_at->format('d F Y, H:i') }}</strong>
                            </p>
                        </div>
                    </div>
                </div>
