...
@section('title', 'Edit Penduduk - Hujjatul')
...
<div class="mb-6">
    <div class="flex items-center gap-4">
        ...
        <h1 class="text-2xl font-bold text-gray-800">Edit Penduduk</h1>
    </div>
</div>

<div>
    <div class="bg-white rounded-lg shadow-md p-6">
        <form id="editPendudukForm" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="nik" name="nik" value="{{ $penduduk->nik }}" required maxlength="16"
                ...
                <div>
                    ...
                    <input type="text" id="nama_lengkap" name="nama_lengkap" value="{{ $penduduk->nama_lengkap }}" required
                ...
                <div>
                    ...
                    <input type="text" id="tempat_lahir" name="tempat_lahir" value="{{ $penduduk->tempat_lahir }}" required
                        class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                ...
                <div>
                    ...
                    <input type="date" id="tanggal_lahir" name="tanggal_lahir" value="{{ $penduduk->tanggal_lahir ? $penduduk->tanggal_lahir->format('Y-m-d') : '' }}" required
                        class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                ...
                <div>
                    ...
                    <select id="status_kawin" name="status_kawin" required
                        ...
                        <option value="Belum Menikah" {{ $penduduk->status_kawin === 'Belum Menikah' ? 'selected' : '' }}>Belum Menikah</option>
                        <option value="Menikah" {{ $penduduk->status_kawin === 'Menikah' ? 'selected' : '' }}>Menikah</option>
                        <option value="Cerai Hidup" {{ $penduduk->status_kawin === 'Cerai Hidup' ? 'selected' : '' }}>Cerai Hidup</option>
                        <option value="Cerai Mati" {{ $penduduk->status_kawin === 'Cerai Mati' ? 'selected' : '' }}>Cerai Mati</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="text" id="desa" name="desa" value="{{ $penduduk->desa }}" required
                        class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                ...
                <div>
                    ...
                    <input type="text" id="pekerjaan" name="pekerjaan" value="{{ $penduduk->pekerjaan }}" required
                        class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
            ...
            <div>
                ...
                <textarea id="alamat" name="alamat" required rows="3"
                    class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                    placeholder="Masukkan alamat lengkap">{{ $penduduk->alamat }}</textarea>
            ...
            <div>
                ...
                <input type="text" id="no_hp" name="no_hp" value="{{ $penduduk->no_hp }}" required
                    class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
...
waitForJQuery(function($) {
    ...
    $('#editPendudukForm').on('submit', function(e) {
        e.preventDefault();
        ...
        $.ajax({
            url: '{{ route("admin.penduduks.update", $penduduk->id) }}',
            method: 'PUT',
            data: $(this).serialize(),
